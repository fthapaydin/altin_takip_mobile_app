...
class _EditGoalSheetState extends ConsumerState<EditGoalSheet> {
  ...
  void initState() {
    ...
    _amountController = TextEditingController(
      text: NumberFormat('#,##0', 'tr_TR').format(widget.goal.targetAmount),
    );
  ...
  Future<void> _submit() async {
    ...
    final success = await ref
        ...
        .updateGoal(
          widget.goal.id,
          name: name != widget.goal.name ? name : null,
          category: _category != widget.goal.category ? _category : null,
          targetAmount: amount != widget.goal.targetAmount ? amount : null,
          targetDate: _targetDate != widget.goal.targetDate
              ? _targetDate
              : null,
          clearTargetDate:
              widget.goal.targetDate != null && _targetDate == null,
          priority: _priority != widget.goal.priority ? _priority : null,
        );
